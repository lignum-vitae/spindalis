use crate::polynomials::{PolynomialError, structs::polynomial::Polynomial};
...
pub fn parse_polynomial<S>(expr: S) -> Result<Polynomial, PolynomialError>
where
    S: AsRef<str>,
{
...
pub fn eval_polynomial<V, S, F>(terms: &[Term], vars: &V) -> Result<f64, PolynomialError>
where
