...
macro_rules! _parse_polynomial {
    ...
    (!entry $coeff:literal $($polynomial:tt)*) => {
        $crate::_parse_polynomial!(!parse [($coeff, 0)] $($polynomial)*)
    };
    ...
    (!parse [$(($parsed_coeff:literal, $parsed_power:literal)),*] + $coeff:literal $($polynomial:tt)*) => {
        $crate::_parse_polynomial!(!parse [$(($parsed_coeff, $parsed_power)),* , ($coeff, 0)] $($polynomial)*)
    };
...
mod tests {
    ...
    fn test_parse_polynomial_simple() {
        ...
        let coeffs_macro = parse_polynomial!(2 x ^ 2 + 3 x + 4);
        let result = vec![
            4.0, // constant term
            3.0, // x^1 term
            2.0, // x^2 term
    ...
    fn test_parse_polynomial_negative_coeffs() {
        ...
        let coeffs_macro = parse_polynomial!(-2 x ^3 - 4 x + 1);
    ...
    fn test_parse_polynomial_implicit_coeff() {
        ...
        let coeffs_macro = parse_polynomial!(x ^ 2 + x + 1);
    ...
    fn test_parse_polynomial_missing_powers() {
        ...
        let coeffs_macro = parse_polynomial!(2 x + 3);
    ...
    fn test_parse_polynomial_multiple_terms_same_power() {
        let coeffs_macro = parse_polynomial!(2 x^2 + 3 x^2);
    ...
    fn test_eval_polynomial_negative() {
        ...
        let coeffs_macro = parse_polynomial!(-x ^ 2 + 4 x - 5);
        assert_eq!(coeffs, coeffs_macro);
    ...
    fn test_parse_and_eval_combined() {
        let coeffs = parse_polynomial("x^3 - 2x + 1").unwrap();
        let coeffs_macro = parse_polynomial!(x^3 - 2 x + 1);
        assert_eq!(coeffs, coeffs_macro);
