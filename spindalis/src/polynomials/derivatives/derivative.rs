pub fn derivative(poly: &[f64]) -> Vec<f64> {
...
mod tests {
    ...
    fn test_derivative_constant() {
        ...
        assert!(deriv.is_empty()); // derivative of constant is zero-length
    }
    ...
    fn test_derivative_linear() {
        ...
        assert_eq!(deriv, vec![3.0]); // derivative: 3
    }
    ...
    fn test_derivative_higher_degree() {
        ...
        // derivative: -4 + 6x + 6x^2 => [-4.0, 6.0, 6.0]
