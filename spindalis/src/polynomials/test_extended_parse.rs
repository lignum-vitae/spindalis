use spindalis_core::polynomials::Term;
use spindalis_core::polynomials::extended::{eval_polynomial_extended, parse_polynomial_extended};
use spindalis_derive::parse_polynomial_extended;
