...
pub mod polynomials {
    ...
    pub use core::polynomial::eval_polynomial;
    pub use core::polynomial::parse_polynomial;
    pub use core::simple::eval_simple_polynomial;
    pub use core::simple::parse_simple_polynomial;
    pub use macros::{parse_polynomial, parse_simple_polynomial};
}

pub mod derivatives {
    pub use spindalis_core::derivatives::polynomial::partial_derivative;
...
pub mod integrals {
    ...
    // Functions
    pub use spindalis_core::integrals::polynomial_indefinite::indefinite_integral_polynomial;
